 ...
 */
public object RxxiaodianHttp {
  /**
   * 本类所有方法都会调用本方法
   */
  private fun <R : RxHttp<*, *>> R.wrapper(): R {
    setDomainToxiaodianIfAbsent()
    return this
  }
  ...
  @JvmStatic
  public fun postEncryptForm(url: String, vararg formatArgs: Any?): RxHttpPostEncryptJsonParam = RxHttp.postEncryptForm(url, *formatArgs).wrapper()
}
