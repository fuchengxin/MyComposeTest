...
import com.chuyou.base.http.D_API_URL
import com.chuyou.base.http.PostEncryptJsonParam
import com.chuyou.base.http.baseUrl
...
public open class RxHttp<P : Param<P>, R : RxHttp<P, R>> protected constructor(
    ...
    public fun setDomainToxiaodianIfAbsent(): R = setDomainIfAbsent(D_API_URL)
    ...
    public companion object {
        ...
        @JvmStatic
        public fun postEncryptForm(url: String, vararg formatArgs: Any?): RxHttpPostEncryptJsonParam = RxHttpPostEncryptJsonParam(PostEncryptJsonParam(format(url, *formatArgs)))
